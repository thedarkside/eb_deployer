...
Gem::Specification.new do |gem|
  ...
  gem.add_runtime_dependency 'aws-sdk-cloudformation',  '~> 1.46', '>= 1.46.0 '
  gem.add_runtime_dependency 'aws-sdk-elasticbeanstalk',  '~> 1.40', '~> 1.40.0'
  gem.add_runtime_dependency 'aws-sdk-s3',  '~> 1', '~> 1.85.0'
